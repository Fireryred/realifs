...
export class BrowseEfforts extends Component {
    constructor() {
        super();
                            ...
                            { Object.entries(efforts).map( (item, key) => {
                                ...
                                return (
                                    <Marker
                                        ...
                                        ref={this[markerName]}
                                        onPress={() => {
                                            Alert.alert("Login or register to donate", undefined, [
                                                { text: "Login", onPress: () => { this.props.navigation.navigate("LoginPortal") } },
                                                { text: "Register", onPress: () => { this.props.navigation.navigate("RegisterScreen") } }
                                            ], {cancelable: true})
                ...
                <Card style={{margin: 3}}>
                    ...
                    <Card.Content>
                        ...
                        <Button
                            ...
                            onPress={() => {
                                Alert.alert("Login or register to donate", undefined, [
                                    { text: "Login", onPress: () => { this.props.parentProps.navigation.navigate("LoginPortal") } },
                                    { text: "Register", onPress: () => { this.props.parentProps.navigation.navigate("RegisterScreen") } }
                                ], {cancelable: true})
                                // this.props.parentProps.navigation.navigate("EffortDetails", {effortId: effortId})
                            }}
                        >VIEW</Button>
